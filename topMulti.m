...
if initialDesign=="top88"
    switch problem
        ...
        case 'MBB2'
        xdens = top88DesignMBB(nelx,nely,volfrac,2,1.2,2); xcos = repmat(1, [nely, nelx]); xsin = repmat(1, [nely, nelx]); xcub = repmat(0, [nely, nelx]);
        case 'MBB3'
        xdens = top88DesignMBB(nelx,nely,volfrac,2,1.2,2); xcos = repmat(1, [nely, nelx]); xsin = repmat(1, [nely, nelx]); xcub = repmat(1, [nely, nelx]);
        case 'MBB4'
        xdens = top88DesignMBB(nelx,nely,volfrac,2,1.2,2); xcos = repmat(1, [nely, nelx]); xsin = repmat(0, [nely, nelx]); xcub = repmat(0.5, [nely, nelx]);
        case 'MBB5'
        xdens = top88DesignMBB(nelx,nely,volfrac,2,1.2,2); xcos = repmat(1, [nely, nelx]); xsin = repmat(0, [nely, nelx]); xcub = repmat(0, [nely, nelx]);
        case 'MBB6'
        xdens = top88DesignMBB(nelx,nely,volfrac,2,1.2,2); xcos = repmat(1, [nely, nelx]); xsin = repmat(0, [nely, nelx]); xcub = repmat(1, [nely, nelx]);
        case 'Canti'
...
elseif initialDesign=="volfrac"
    switch problem
        ...
        case 'vol2' 
        xdens = repmat(volfrac, [nely, nelx]); xcos = repmat(1, [nely, nelx]); xsin = repmat(1, [nely, nelx]); xcub = repmat(0, [nely, nelx]);
        case 'vol3' 
        xdens = repmat(volfrac, [nely, nelx]); xcos = repmat(1, [nely, nelx]); xsin = repmat(1, [nely, nelx]); xcub = repmat(1, [nely, nelx]);
        case 'vol4' 
        xdens = repmat(volfrac, [nely, nelx]); xcos = repmat(1, [nely, nelx]); xsin = repmat(0, [nely, nelx]); xcub = repmat(0.5, [nely, nelx]);
        case 'vol5' 
        xdens = repmat(volfrac, [nely, nelx]); xcos = repmat(1, [nely, nelx]); xsin = repmat(0, [nely, nelx]); xcub = repmat(0, [nely, nelx]);
        case 'vol6' 
        xdens = repmat(volfrac, [nely, nelx]); xcos = repmat(1, [nely, nelx]); xsin = repmat(0, [nely, nelx]); xcub = repmat(1, [nely, nelx]);
    end
end
